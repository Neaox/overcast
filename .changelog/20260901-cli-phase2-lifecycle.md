...
+ [cli] `overcast status` lists every registered instance (name, backend, endpoint, running/stopped/unknown state) alongside its existing single-endpoint health check
