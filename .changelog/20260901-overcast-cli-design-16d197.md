...
+ [cli] `overcast aws` tab-completes its passthrough arguments via the AWS CLI's own
  `aws_completer` when it is installed, falling back to file completion otherwise
