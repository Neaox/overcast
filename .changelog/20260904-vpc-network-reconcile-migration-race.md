* [ec2/router] VPC networks are no longer deleted when Overcast restarts into a schema migration, stranding every ECS task and Lambda in the VPC
  ...
  Placements failed with `ResourceInitializationError: â€¦ connect to VPC network <id>: 404: network <id> not found` for the life of the process, through redeploys alike.
