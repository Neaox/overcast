...
func (h *Handler) typedOps() map[string]op.Operation {
	return map[string]op.Operation{
		...
		"ModifyLoadBalancerAttributes":   op.NewTyped("ModifyLoadBalancerAttributes", h.modifyLoadBalancerAttributesTyped),
		"DescribeLoadBalancerAttributes": op.NewTyped("DescribeLoadBalancerAttributes", h.describeLoadBalancerAttributesTyped),
