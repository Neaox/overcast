...
func init() {
	capabilities.Default.Register(
		...
		// Item operations
		capabilities.Capability{Service: "dynamodb", Operation: "PutItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "Includes `ConditionExpression`, `ReturnValues` (`ALL_OLD`); records AWS/DynamoDB CloudWatch metrics SuccessfulRequestLatency, ConsumedWriteCapacityUnits, UserErrors/SystemErrors"},
		capabilities.Capability{Service: "dynamodb", Operation: "GetItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "Includes `ProjectionExpression`; records SuccessfulRequestLatency, ConsumedReadCapacityUnits, UserErrors/SystemErrors"},
		capabilities.Capability{Service: "dynamodb", Operation: "UpdateItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "SET/REMOVE/ADD/DELETE clauses; all `ReturnValues` variants; upsert; records SuccessfulRequestLatency, ConsumedWriteCapacityUnits, UserErrors/SystemErrors"},
		capabilities.Capability{Service: "dynamodb", Operation: "DeleteItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "`ConditionExpression`, `ReturnValues` (`ALL_OLD`); records SuccessfulRequestLatency, ConsumedWriteCapacityUnits, UserErrors/SystemErrors"},
		capabilities.Capability{Service: "dynamodb", Operation: "BatchGetItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "Up to 100 items across tables; records SuccessfulRequestLatency/ConsumedReadCapacityUnits per table touched"},
		capabilities.Capability{Service: "dynamodb", Operation: "BatchWriteItem", Category: "Item operations", Status: capabilities.StatusSupported, Notes: "Up to 25 put/delete operations; records SuccessfulRequestLatency/ConsumedWriteCapacityUnits per table touched"},
		// Query & scan
		...
		capabilities.Capability{Service: "dynamodb", Operation: "TransactGetItems", Category: "Transactions", Status: capabilities.StatusSupported, Notes: "Up to 100 items across tables; records SuccessfulRequestLatency/ConsumedReadCapacityUnits per table (2x weighted, matching AWS's transactional-read capacity accounting)"},
		capabilities.Capability{Service: "dynamodb", Operation: "TransactWriteItems", Category: "Transactions", Status: capabilities.StatusSupported, Notes: "Put, Update, Delete, ConditionCheck; all-or-nothing; records SuccessfulRequestLatency/ConsumedWriteCapacityUnits per table (2x weighted, matching AWS's transactional-write capacity accounting)"},
		// Tags
