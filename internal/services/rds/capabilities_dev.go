...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "rds", Operation: "ModifyDBInstance", Category: "DB instances", Status: capabilities.StatusSupported, Notes: "Metadata updates (class, storage, engine version, multi-AZ); `MasterUserPassword` is applied to the running engine, and requires an `available` instance"},
