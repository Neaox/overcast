...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "ecs", Operation: "RegisterTaskDefinition", Category: "General", Status: capabilities.StatusSupported, Notes: "Family:revision versioning; Fargate: validates awsvpc networkMode, cpu/memory required with valid combos; volumes with efsVolumeConfiguration and container mountPoints supported (EFS volumes mounted in live mode)"},
