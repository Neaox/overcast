...
func init() {
	capabilities.Default.Register(
		...
		// Publishing
		capabilities.Capability{Service: "sns", Operation: "Publish", Category: "Publishing", Status: capabilities.StatusSupported, Notes: "Async fan-out to `sqs`, `lambda`, `email`, `email-json`, `http`, `https`, and `sms` subscribers"},
