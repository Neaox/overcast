...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "sns", Operation: "PublishBatch", Category: "Publishing", Status: capabilities.StatusSupported, Notes: "Up to 10 messages; each entry independently validated (Message/Subject/MessageStructure=json), a bad entry fails without aborting the batch"},
