...
func init() {
	capabilities.Default.RegisterForService(serviceName,
		capabilities.Capability{Operation: "CreateServer", Status: capabilities.StatusInert, Notes: "Inline `Tags` applied at creation"},
		...
		capabilities.Capability{Operation: "CreateUser", Status: capabilities.StatusInert, Notes: "Inline `Tags` applied at creation"},
		...
		capabilities.Capability{Operation: "TagResource", Status: capabilities.StatusInert, Notes: "Server and user ARNs; Transfer's other taggable resources are not emulated"},
		capabilities.Capability{Operation: "UntagResource", Status: capabilities.StatusInert},
		capabilities.Capability{Operation: "ListTagsForResource", Status: capabilities.StatusInert, Notes: "No pagination; every tag is returned in one page"},
	)
}
