...
// real Secrets Manager operation Overcast has not implemented gets an honest
...
func TestDispatch_unimplementedVsUnknownOperation(t *testing.T) {
	// Given: StopReplicationToReplica is a real, documented Secrets Manager
	// operation (internal/awsapi/manifest.gen.go) with no handler here, not
	// even one of the registered stubs that answer 501 themselves.
	const unimplemented, unknown = "StopReplicationToReplica", "NotASecretsManagerOperation"
