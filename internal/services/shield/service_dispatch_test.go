...
// real Shield operation Overcast has not implemented gets an honest 501, in
...
func TestDispatch_unimplementedVsUnknownOperation(t *testing.T) {
	// Given: AssociateDRTRole is a real, documented Shield operation
	// (internal/awsapi/manifest.gen.go) with no handler here.
	const unimplemented, unknown = "AssociateDRTRole", "NotAShieldOperation"
