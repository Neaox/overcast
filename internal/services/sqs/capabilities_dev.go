...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "sqs", Operation: "ReceiveMessage", Category: "Message operations",
			Status: capabilities.StatusSupported, Notes: "MaxNumberOfMessages, VisibilityTimeout, WaitTimeSeconds, queue default long polling, FIFO ReceiveRequestAttemptId"},
