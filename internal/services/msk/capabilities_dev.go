...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "msk", Operation: "CreateCluster", Category: "Clusters",
			Status: capabilities.StatusSupported, Notes: "Docker-backed (Redpanda); async CREATING→ACTIVE via TCP health check; port auto-alloc from MSK_PORT_BASE; a cluster name already in use in the region is a `ConflictException`"},
