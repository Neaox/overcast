...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "msk", Operation: "CreateClusterV2", Category: "Clusters",
			Status: capabilities.StatusSupported, Notes: "PROVISIONED: same Docker/Redpanda lifecycle as v1; SERVERLESS: metadata-only, immediately ACTIVE; rejects a request naming both or neither"},
