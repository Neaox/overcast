...
func init() {
	capabilities.Default.Register(
		...
		// SES v2 — Identities
		capabilities.Capability{Service: "ses", Operation: "V2CreateEmailIdentity", Category: "SES v2 — Identities", Status: capabilities.StatusSupported, Notes: "`PUT /v2/email/identities`; auto-verified; inline `Tags` applied at creation", DisplayName: "CreateEmailIdentity", DocOnly: true, DocsURL: "[docs](https://docs.aws.amazon.com/ses/latest/APIReference-V2/API_CreateEmailIdentity.html)"},
