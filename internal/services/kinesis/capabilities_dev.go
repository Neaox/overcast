...
func init() {
	capabilities.Default.Register(
		...
		capabilities.Capability{Service: "kinesis", Operation: "CreateStream", Category: "General", Status: capabilities.StatusSupported, Notes: "Stream becomes ACTIVE immediately; inline `Tags` applied at creation"},
