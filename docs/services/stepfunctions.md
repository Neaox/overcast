...
| Operation             | Status       | Notes                                                                    | AWS Docs                                                                                            |
| --------------------- | ------------ | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| `StartExecution`      | ✅ Supported | Interprets the ASL; returns while the execution is RUNNING, as AWS does  | [docs](https://docs.aws.amazon.com/step-functions/latest/apireference/API_StartExecution.html)      |
| `StartSyncExecution`  | ✅ Supported | EXPRESS only — same interpreter, run to completion before returning      | [docs](https://docs.aws.amazon.com/step-functions/latest/apireference/API_StartSyncExecution.html)  |
