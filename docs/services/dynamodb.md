...
| `ListTables`             | ✅ Supported   | Limit/ExclusiveStartTableName currently ignored — returns all tables in one response                               | [docs](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ListTables.html)             |
