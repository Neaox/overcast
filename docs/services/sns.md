...
| `PublishBatch`                                   | ✅ Supported | Up to 10 messages; each entry independently validated (Message/Subject/MessageStructure=json), a bad entry fails without aborting the batch                                                                                                                                                                           | [docs](https://docs.aws.amazon.com/sns/latest/api/API_PublishBatch.html)        |
