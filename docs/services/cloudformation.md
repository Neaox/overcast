...
| `ListStacks`             | ✅ Supported   | Filter by status; summaries carry StackStatusReason                                                     | [docs](https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_ListStacks.html)             |
