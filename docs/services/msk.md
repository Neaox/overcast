...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Broker count                                   | `NumberOfBrokerNodes` brokers                                                                                           | Recorded, not honoured — a single Redpanda node whatever the request asks for                                                                                                                                                  |
| Broker software                                | Apache Kafka                                                                                                            | Redpanda: wire-compatible with the Kafka protocol, but broker internals, JMX metrics and Kafka-specific admin behaviour differ                                                                                                 |
| `ListKafkaVersions`                            | The versions the service offers                                                                                         | Fixed at 3.6.0, 3.5.1, 3.4.0, 2.8.1 and 2.6.0, whatever the container runs                                                                                                                                                     |
| Broker changes                                 | `UpdateBrokerCount`, `UpdateBrokerStorage`, `UpdateBrokerType`, `UpdateMonitoring`, `UpdateSecurity` and `RebootBroker` | All return `501`                                                                                                                                                                                                               |
| SASL/SCRAM                                     | The secret-association operations, and an authenticated broker                                                          | They return `501`; the broker is reachable without authentication                                                                                                                                                              |
| VPC connections                                | `CreateVpcConnection` and its siblings                                                                                  | They return `501`                                                                                                                                                                                                              |
| Encryption, auth, logging and storage settings | Applied to the cluster                                                                                                  | `encryptionInfo`, `clientAuthentication`, `loggingInfo`, `openMonitoring` and a broker group's `storageInfo` are discarded — a cluster keeps only `instanceType`, `clientSubnets`, `securityGroups` and `brokerAZDistribution` |
