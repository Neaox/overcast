...
| `DescribeAddresses`             | ✅ Supported | Selects by AllocationId.N; Filters: allocation-id, association-id, domain, instance-id, network-interface-id, private-ip-address, public-ip                                                                        | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAddresses.html)             |
