...
| `CreateVpc`                     | ✅ Supported | CidrBlock required; creates Docker bridge network (`--internal` unless IGW attached) | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVpc.html)                     |
