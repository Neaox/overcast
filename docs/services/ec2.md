...
| `DescribeInstances`             | ✅ Supported | Filter by instance-id, instance-state-name, tag:<key>, tag-key, tag-value                                            | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstances.html)             |
| `DescribeInternetGateways`      | ✅ Supported | Filter by internet-gateway-id, attachment.vpc-id, tag:<key>, tag-key, tag-value                                      | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInternetGateways.html)      |
...
| `DescribeNatGateways`           | ✅ Supported | Filter by nat-gateway-id, vpc-id, subnet-id, state, tag:<key>, tag-key, tag-value                                    | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNatGateways.html)           |
| `DescribeNetworkInterfaces`     | ✅ Supported | Filter by network-interface-id, subnet-id, vpc-id, tag:<key>, tag-key, tag-value                                     | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeNetworkInterfaces.html)     |
...
| `DescribeRouteTables`           | ✅ Supported | Filter by route-table-id, vpc-id, tag:<key>, tag-key, tag-value; includes NAT gateway routes                         | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRouteTables.html)           |
| `DescribeSecurityGroups`        | ✅ Supported | Filter by group-id, group-name, vpc-id, tag:<key>, tag-key, tag-value                                                | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSecurityGroups.html)        |
| `DescribeSubnets`               | ✅ Supported | Filter by subnet-id, vpc-id, availability-zone, tag:<key>, tag-key, tag-value; includes tagSet for CDK subnet groups | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeSubnets.html)               |
...
| `DescribeVpnGateways`           | ✅ Supported | Filter by vpn-gateway-id, state, type, attachment.vpc-id, attachment.state, tag:<key>, tag-key, tag-value            | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpnGateways.html)           |
...
| `DescribeVpcs`                  | ✅ Supported | Filter by VpcId, vpc-id, isDefault, tag:<key>, tag-key, tag-value                                                    | [docs](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcs.html)                  |
