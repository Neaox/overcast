...
| Operation          | Status       | Notes | AWS Docs                                                                          |
| ------------------ | ------------ | ----- | --------------------------------------------------------------------------------- |
| `GetBucketCors`    | ✅ Supported |       | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketCors.html)    |
| `PutBucketCors`    | ✅ Supported |       | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketCors.html)    |
...
| Operation             | Status       | Notes                           | AWS Docs                                                                             |
| --------------------- | ------------ | ------------------------------- | ------------------------------------------------------------------------------------ |
| `GetBucketWebsite`    | ✅ Supported | IndexDocument and ErrorDocument | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetBucketWebsite.html)    |
| `PutBucketWebsite`    | ✅ Supported | IndexDocument and ErrorDocument | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketWebsite.html)    |
...
| `PutBucketLifecycleConfiguration` | ✅ Supported | Expiration, Transition, AbortIncompleteMultipartUpload and prefix/tag/size filters, applied by an hourly sweeper; version-dependent rules (NoncurrentVersion*, ExpiredObjectDeleteMarker) are rejected rather than stored | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketLifecycleConfiguration.html) |
