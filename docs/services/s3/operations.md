...
| `CompleteMultipartUpload` | ✅ Supported   | Honours the same If-None-Match: * and If-Match conditional writes as PutObject, evaluated at completion time | [docs](https://docs.aws.amazon.com/AmazonS3/latest/API/API_CompleteMultipartUpload.html) |
