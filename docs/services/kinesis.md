...
| `CreateStream`                  | ✅ Supported | Stream becomes ACTIVE immediately; inline `Tags` applied at creation       | [docs](https://docs.aws.amazon.com/kinesis/latest/APIReference/API_CreateStream.html)                  |
