...
| ------------------------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `CreateAutoScalingGroup`              | ✅ Supported | Reconciles: launches EC2 instances to DesiredCapacity from a LaunchConfiguration or a LaunchTemplate, resolved through EC2 at create time. MixedInstancesPolicy and InstanceId are refused with 501 |          |
| `UpdateAutoScalingGroup`              | ✅ Supported | Min/max/desired changes re-converge the group; desired outside min/max is AWS's ValidationError. Setting either launch source clears the other                                                      |          |
