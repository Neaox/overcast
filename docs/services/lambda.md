...
| `CreateFunction`                  | ✅ Supported | Stores metadata; validates runtime; deprecated runtimes rejected; auto-creates CWL log group; VpcConfig, ImageConfig, and FileSystemConfigs supported (EFS volumes mounted in live mode) | [docs](https://docs.aws.amazon.com/lambda/latest/dg/API_CreateFunction.html)                  |
