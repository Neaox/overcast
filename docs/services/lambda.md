...
| `CreateFunction`               | ✅ Supported | Stores metadata; validates Zip/Image required fields, package type, runtime, timeout, memory, and architecture bounds; deprecated runtimes rejected; auto-creates CWL log group; VpcConfig and ImageConfig supported | [docs](https://docs.aws.amazon.com/lambda/latest/dg/API_CreateFunction.html)               |
