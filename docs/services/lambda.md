...
- Async invocation (`InvocationType: Event`) is accepted and executed, but the
  ...
  EventBridge and Scheduler targets, and SNS `lambda` subscriptions â€” all of
