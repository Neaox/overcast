...
| [#775](https://github.com/Neaox/overcast/issues/775) | [priority:P3] emit platform.initStart and platform.initReport records for La... | 10 | 40 | 0.25 | 0.5 | 0.5 | `p3` | `p3` | resolved by #1419 (in-container init Phase 4, issue #1410); the source TODO is gone |
