...
> **Status:** IMPLEMENTED (2026-07-25) — phase 1 numeric encoding (#283), phase 2 index structure (#287), phase 3 read-path flip + Transact maintenance + projection fidelity (this PR). Deferred follow-ups from §5/§7: LSI routing fix DONE (2026-08-03), ConsistentRead-on-GSI ValidationException DONE (2026-08-03); parallel-scan segmentation remains open. Originally: design-first, gated per [storage-access-plan.md A7](./storage-access-plan.md#a7--dynamodb-gsi-query-secondary-index) — no code in this PR. Reviewer verdict requested at the bottom.
