...
var scenarioBackends = []string{"cli", "go-sdk", "java-sdk", "node-js-sdk", "python-sdk", "rust-sdk"}
...
// rustSDKSuite is the suite the Rust source emitter (emit_rust.go) writes for,
// named for the same two reasons.
const rustSDKSuite = "rust-sdk"
