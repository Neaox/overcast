  ...
  return (
    ...
    >
      ...
      {viewportEl &&
        createPortal(
          <div
            className="pointer-events-auto absolute rounded-full border border-border bg-bg-elevated px-3 py-0.5 font-mono text-[10px] tracking-[0.12em] whitespace-nowrap text-fg-muted uppercase shadow-sm transition-opacity duration-200"
            style={{
