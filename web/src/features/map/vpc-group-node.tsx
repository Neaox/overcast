...
export const VpcGroupNode = memo(function VpcGroupNode({ data, width, height }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto absolute -top-3 left-3 z-10 flex items-center gap-1 rounded-full border border-dashed border-cat-5/30 bg-bg-elevated px-2 py-0.5 font-mono text-2xs tracking-[0.12em] text-cat-5 shadow-sm">
