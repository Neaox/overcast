...
In this repo: the README quickstart is a tutorial; `docs/sdk-cli.md` is how-to; `docs/services/*.md` is reference; `docs/dev/architecture.md` is explanation.
...
| `docs/services/*.md` | users, per-service reference | yes — capability tables generated | applies |
