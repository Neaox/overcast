...
public sealed class DynamoDbGroup(AwsClients clients) : IServiceGroup
{
    ...
    {
        ["dynamodb-tables:CreateTable"] = CreateTableAsync,
        ["dynamodb-tables:DescribeTable"] = DescribeTableAsync,
        ["dynamodb-tables:ListTables"] = ListTablesAsync,
        ["dynamodb-tables:UpdateTable"] = UpdateTableAsync,
        ["dynamodb-tables:DeleteTable"] = DeleteTableAsync,
        ["dynamodb-items:PutItem"] = PutItemAsync,
        ["dynamodb-items:GetItem"] = GetItemAsync,
        ["dynamodb-items:UpdateItem"] = UpdateItemAsync,
        ["dynamodb-items:PutItemConditionFail"] = PutItemConditionFailAsync,
        ["dynamodb-items:DeleteItem"] = DeleteItemAsync,
        ["dynamodb-query:Query"] = QueryAsync,
        ["dynamodb-query:QueryWithFilterExpression"] = QueryWithFilterExpressionAsync,
        ["dynamodb-query:QueryWithLimit"] = QueryWithLimitAsync,
        ["dynamodb-query:QueryPagination"] = QueryPaginationAsync,
        ["dynamodb-query:Scan"] = ScanAsync,
        ["dynamodb-query:ScanWithFilter"] = ScanWithFilterAsync,
        ["dynamodb-batch:BatchWriteItem"] = BatchWriteItemAsync,
        ["dynamodb-batch:BatchGetItem"] = BatchGetItemAsync,
        ["dynamodb-txn:TransactWriteItems"] = TransactWriteItemsAsync,
        ["dynamodb-txn:TransactGetItems"] = TransactGetItemsAsync,
        ["dynamodb-txn:TransactWriteConditionFail"] = TransactWriteConditionFailAsync,
        ["dynamodb-ttl:UpdateTimeToLive"] = UpdateTimeToLiveAsync,
        ["dynamodb-ttl:DescribeTimeToLive"] = DescribeTimeToLiveAsync,
    };
