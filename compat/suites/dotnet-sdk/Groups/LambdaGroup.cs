...
public sealed class LambdaGroup(AwsClients clients) : IServiceGroup
{
    public IReadOnlyDictionary<string, TestFn> Impls() => new Dictionary<string, TestFn>(StringComparer.Ordinal)
    {
        ...
        ["lambda-crud:UpdateFunctionCode"] = UpdateFunctionCodeAsync,
        ["lambda-crud:UpdateFunctionConfiguration"] = UpdateFunctionConfigurationAsync,
        ...
        ["lambda-invoke:InvokeDryRun"] = InvokeDryRunAsync,
        ["lambda-invoke:InvokeSync"] = InvokeSyncAsync,
        ["lambda-invoke:InvokeAsync"] = InvokeAsyncAsync,
        ["lambda-invoke-stream:InvokeWithResponseStream"] = InvokeWithResponseStreamAsync,
        ["lambda-invoke-error:InvokeWithError"] = InvokeWithErrorAsync,
        ["lambda-aliases:PublishVersion"] = PublishVersionAsync,
        ["lambda-aliases:ListVersionsByFunction"] = ListVersionsByFunctionAsync,
        ["lambda-aliases:CreateAlias"] = CreateAliasAsync,
        ["lambda-aliases:GetAlias"] = GetAliasAsync,
        ["lambda-aliases:ListAliases"] = ListAliasesAsync,
        ["lambda-aliases:UpdateAlias"] = UpdateAliasAsync,
        ["lambda-aliases:DeleteAlias"] = DeleteAliasAsync,
        ["lambda-layers:PublishLayerVersion"] = PublishLayerVersionAsync,
        ["lambda-layers:ListLayers"] = ListLayersAsync,
        ["lambda-layers:DeleteLayerVersion"] = DeleteLayerVersionAsync,
    };
