...
public sealed class SecretsManagerGroup(AwsClients clients) : IServiceGroup
{
    ...
    {
        ["secretsmanager-crud:CreateSecret"] = CreateSecretAsync,
        ["secretsmanager-crud:GetSecretValue"] = GetSecretValueAsync,
        ["secretsmanager-crud:DescribeSecret"] = DescribeSecretAsync,
        ["secretsmanager-crud:PutSecretValue"] = PutSecretValueAsync,
        ["secretsmanager-crud:ListSecretVersionIds"] = ListSecretVersionIdsAsync,
        ["secretsmanager-crud:UpdateSecret"] = UpdateSecretAsync,
        ["secretsmanager-crud:TagResource"] = TagResourceAsync,
        ["secretsmanager-crud:UntagResource"] = UntagResourceAsync,
        ["secretsmanager-crud:GetRandomPassword"] = GetRandomPasswordAsync,
        ["secretsmanager-crud:BatchGetSecretValue"] = BatchGetSecretValueAsync,
        ["secretsmanager-crud:ListSecrets"] = ListSecretsAsync,
        ["secretsmanager-crud:DeleteSecret"] = DeleteSecretAsync,
        ["secretsmanager-rotate:RotateSecretWithoutLambda"] = RotateSecretWithoutLambdaAsync,
        ["secretsmanager-rotate:RotateSecret"] = RotateSecretAsync,
        ["secretsmanager-rotate:PutSecretValuePending"] = PutSecretValuePendingAsync,
        ["secretsmanager-rotate:GetSecretValueByStage"] = GetSecretValueByStageAsync,
        ["secretsmanager-rotate:UpdateSecretVersionStage"] = UpdateSecretVersionStageAsync,
        ["secretsmanager-rotate:CancelRotateSecret"] = CancelRotateSecretAsync,
        ["secretsmanager-policy:ValidateResourcePolicy"] = ValidateResourcePolicyAsync,
        ["secretsmanager-policy:PutResourcePolicy"] = PutResourcePolicyAsync,
        ["secretsmanager-policy:GetResourcePolicy"] = GetResourcePolicyAsync,
        ["secretsmanager-policy:DeleteResourcePolicy"] = DeleteResourcePolicyAsync,
    };
