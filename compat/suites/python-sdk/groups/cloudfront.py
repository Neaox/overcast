...
IMPLS = {
    # Distributions
    "cloudfront-distributions:CreateDistribution": CreateDistribution,
    "cloudfront-distributions:GetDistribution": GetDistribution,
    "cloudfront-distributions:ListDistributions": ListDistributions,
    "cloudfront-distributions:DeleteDistribution": DeleteDistribution,
    # OAC
    "cloudfront-oac:CreateOriginAccessControl": CreateOriginAccessControl,
    "cloudfront-oac:GetOriginAccessControl": GetOriginAccessControl,
    "cloudfront-oac:UpdateOriginAccessControl": UpdateOriginAccessControl,
    "cloudfront-oac:ListOriginAccessControls": ListOriginAccessControls,
    "cloudfront-oac:DeleteOriginAccessControl": DeleteOriginAccessControl,
    # Cache Policy
    "cloudfront-cache-policy:CreateCachePolicy": CreateCachePolicy,
    "cloudfront-cache-policy:GetCachePolicy": GetCachePolicy,
    "cloudfront-cache-policy:GetCachePolicyConfig": GetCachePolicyConfig,
    "cloudfront-cache-policy:UpdateCachePolicy": UpdateCachePolicy,
    "cloudfront-cache-policy:ListCachePolicies": ListCachePolicies,
    "cloudfront-cache-policy:DeleteCachePolicy": DeleteCachePolicy,
    # Key Group
    "cloudfront-key-group:CreateKeyGroup": CreateKeyGroup,
    "cloudfront-key-group:GetKeyGroup": GetKeyGroup,
    "cloudfront-key-group:GetKeyGroupConfig": GetKeyGroupConfig,
    "cloudfront-key-group:UpdateKeyGroup": UpdateKeyGroup,
    "cloudfront-key-group:ListKeyGroups": ListKeyGroups,
    "cloudfront-key-group:DeleteKeyGroup": DeleteKeyGroup,
    # Realtime Log
    "cloudfront-realtime-log:CreateRealtimeLogConfig": CreateRealtimeLogConfig,
    "cloudfront-realtime-log:GetRealtimeLogConfig": GetRealtimeLogConfig,
    "cloudfront-realtime-log:UpdateRealtimeLogConfig": UpdateRealtimeLogConfig,
    "cloudfront-realtime-log:ListRealtimeLogConfigs": ListRealtimeLogConfigs,
    "cloudfront-realtime-log:DeleteRealtimeLogConfig": DeleteRealtimeLogConfig,
    # Monitoring
    "cloudfront-monitoring:CreateMonitoringSubscription": CreateMonitoringSubscription,
    "cloudfront-monitoring:GetMonitoringSubscription": GetMonitoringSubscription,
    "cloudfront-monitoring:DeleteMonitoringSubscription": DeleteMonitoringSubscription,
    # FLE Config
    "cloudfront-fle-config:CreateFieldLevelEncryptionConfig": CreateFieldLevelEncryptionConfig,
    "cloudfront-fle-config:GetFieldLevelEncryption": GetFieldLevelEncryption,
    "cloudfront-fle-config:GetFieldLevelEncryptionConfig": GetFieldLevelEncryptionConfig,
    "cloudfront-fle-config:UpdateFieldLevelEncryptionConfig": UpdateFieldLevelEncryptionConfig,
    "cloudfront-fle-config:ListFieldLevelEncryptionConfigs": ListFieldLevelEncryptionConfigs,
    "cloudfront-fle-config:DeleteFieldLevelEncryption": DeleteFieldLevelEncryption,
    # FLE Profile
    "cloudfront-fle-profile:CreateFieldLevelEncryptionProfile": CreateFieldLevelEncryptionProfile,
    "cloudfront-fle-profile:GetFieldLevelEncryptionProfile": GetFieldLevelEncryptionProfile,
    "cloudfront-fle-profile:GetFieldLevelEncryptionProfileConfig": GetFieldLevelEncryptionProfileConfig,
    "cloudfront-fle-profile:UpdateFieldLevelEncryptionProfile": UpdateFieldLevelEncryptionProfile,
    "cloudfront-fle-profile:ListFieldLevelEncryptionProfiles": ListFieldLevelEncryptionProfiles,
    "cloudfront-fle-profile:DeleteFieldLevelEncryptionProfile": DeleteFieldLevelEncryptionProfile,
    # Continuous Deployment
    "cloudfront-continuous-deployment:CreateContinuousDeploymentPolicy": CreateContinuousDeploymentPolicy,
    "cloudfront-continuous-deployment:GetContinuousDeploymentPolicy": GetContinuousDeploymentPolicy,
    "cloudfront-continuous-deployment:GetContinuousDeploymentPolicyConfig": GetContinuousDeploymentPolicyConfig,
    "cloudfront-continuous-deployment:UpdateContinuousDeploymentPolicy": UpdateContinuousDeploymentPolicy,
    "cloudfront-continuous-deployment:ListContinuousDeploymentPolicies": ListContinuousDeploymentPolicies,
    "cloudfront-continuous-deployment:DeleteContinuousDeploymentPolicy": DeleteContinuousDeploymentPolicy,
}
