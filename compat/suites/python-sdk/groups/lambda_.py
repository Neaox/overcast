...
IMPLS = {
    ...
    "lambda-crud:UpdateFunctionCode": UpdateFunctionCode,
    "lambda-crud:UpdateFunctionConfiguration": UpdateFunctionConfiguration,
    ...
    "lambda-invoke:InvokeDryRun": InvokeDryRun,
    "lambda-invoke:InvokeSync": InvokeSync,
    "lambda-invoke:InvokeAsync": InvokeAsync,
    "lambda-invoke-stream:InvokeWithResponseStream": InvokeWithResponseStream,
    "lambda-invoke-error:InvokeWithError": InvokeWithError,
    "lambda-aliases:PublishVersion": PublishVersion,
    "lambda-aliases:ListVersionsByFunction": ListVersionsByFunction,
    "lambda-aliases:CreateAlias": CreateAlias,
    "lambda-aliases:GetAlias": GetAlias,
    "lambda-aliases:ListAliases": ListAliases,
    "lambda-aliases:UpdateAlias": UpdateAlias,
    "lambda-aliases:DeleteAlias": DeleteAlias,
    "lambda-layers:PublishLayerVersion": PublishLayerVersion,
    "lambda-layers:ListLayers": ListLayers,
    "lambda-layers:DeleteLayerVersion": DeleteLayerVersion,
}
