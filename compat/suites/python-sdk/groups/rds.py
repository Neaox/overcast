...
IMPLS = {
    "rds-instances:DescribeDBEngineVersions": DescribeDBEngineVersions,
    "rds-instances:CreateDBInstance": CreateDBInstance,
    "rds-instances:DescribeDBInstances": DescribeDBInstances,
    "rds-instances:StopDBInstance": StopDBInstance,
    "rds-instances:StartDBInstance": StartDBInstance,
    "rds-instances:ModifyDBInstance": ModifyDBInstance,
    "rds-instances:DeleteDBInstance": DeleteDBInstance,
    "rds-subnet-groups:CreateDBSubnetGroup": CreateDBSubnetGroup,
    "rds-subnet-groups:DescribeDBSubnetGroups": DescribeDBSubnetGroups,
    "rds-subnet-groups:DeleteDBSubnetGroup": DeleteDBSubnetGroup,
    "rds-parameter-groups:CreateDBParameterGroup": CreateDBParameterGroup,
    "rds-parameter-groups:DescribeDBParameterGroups": DescribeDBParameterGroups,
    "rds-parameter-groups:DeleteDBParameterGroup": DeleteDBParameterGroup,
    "rds-clusters:CreateDBCluster": CreateDBCluster,
    "rds-clusters:DescribeDBClusters": DescribeDBClusters,
    "rds-clusters:ModifyDBCluster": ModifyDBCluster,
    "rds-clusters:StopDBCluster": StopDBCluster,
    "rds-clusters:StartDBCluster": StartDBCluster,
    "rds-clusters:DeleteDBCluster": DeleteDBCluster,
    "rds-cluster-members:CreateClusterForMembers": CreateClusterForMembers,
    "rds-cluster-members:AddClusterMember": AddClusterMember,
    "rds-cluster-members:DescribeClusterMembers": DescribeClusterMembers,
    "rds-cluster-members:DescribeMemberInheritedSettings": DescribeMemberInheritedSettings,
    "rds-cluster-members:RemoveClusterMember": RemoveClusterMember,
    "rds-cluster-members:DeleteClusterAfterMembers": DeleteClusterAfterMembers,
}
