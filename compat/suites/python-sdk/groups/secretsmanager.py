...
IMPLS = {
    "secretsmanager-crud:CreateSecret": CreateSecret,
    "secretsmanager-crud:GetSecretValue": GetSecretValue,
    "secretsmanager-crud:DescribeSecret": DescribeSecret,
    "secretsmanager-crud:PutSecretValue": PutSecretValue,
    "secretsmanager-crud:ListSecretVersionIds": ListSecretVersionIds,
    "secretsmanager-crud:UpdateSecret": UpdateSecret,
    "secretsmanager-crud:TagResource": TagResource,
    "secretsmanager-crud:UntagResource": UntagResource,
    "secretsmanager-crud:GetRandomPassword": GetRandomPassword,
    "secretsmanager-crud:BatchGetSecretValue": BatchGetSecretValue,
    "secretsmanager-crud:ListSecrets": ListSecrets,
    "secretsmanager-crud:DeleteSecret": DeleteSecret,
    "secretsmanager-rotate:RotateSecretWithoutLambda": RotateSecretWithoutLambda,
    "secretsmanager-rotate:RotateSecret": RotateSecret,
    "secretsmanager-rotate:PutSecretValuePending": PutSecretValuePending,
    "secretsmanager-rotate:GetSecretValueByStage": GetSecretValueByStage,
    "secretsmanager-rotate:UpdateSecretVersionStage": UpdateSecretVersionStage,
    "secretsmanager-rotate:CancelRotateSecret": CancelRotateSecret,
    "secretsmanager-policy:ValidateResourcePolicy": ValidateResourcePolicy,
    "secretsmanager-policy:PutResourcePolicy": PutResourcePolicy,
    "secretsmanager-policy:GetResourcePolicy": GetResourcePolicy,
    "secretsmanager-policy:DeleteResourcePolicy": DeleteResourcePolicy,
}
