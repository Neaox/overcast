...
IMPLS = {
    "kms-keys:CreateKey": CreateKey,
    "kms-keys:DescribeKey": DescribeKey,
    "kms-keys:PutKeyPolicy": PutKeyPolicy,
    "kms-keys:CreateKmsAlias": CreateAlias,
    "kms-keys:ListKmsAliases": ListAliases,
    "kms-keys:ListKeys": ListKeys,
    "kms-keys:DisableKey": DisableKey,
    "kms-keys:EnableKey": EnableKey,
    "kms-keys:ScheduleKeyDeletion": ScheduleKeyDeletion,
    "kms-keys:CancelKeyDeletion": CancelKeyDeletion,
    "kms-keys:TagKMSResource": TagKMSResource,
    "kms-keys:ListKMSResourceTags": ListKMSResourceTags,
    "kms-keys:UntagKMSResource": UntagKMSResource,
    "kms-crypto:Encrypt": Encrypt,
    "kms-crypto:Decrypt": Decrypt,
    "kms-crypto:GenerateDataKey": GenerateDataKey,
    "kms-crypto:GenerateDataKeyWithoutPlaintext": GenerateDataKeyWithoutPlaintext,
    "kms-asymmetric:Sign": Sign,
    "kms-asymmetric:Verify": Verify,
}
