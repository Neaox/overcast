...
IMPLS = {
    ...
    "ecs-clusters:DescribeClusters": DescribeClusters,
    "ecs-clusters:ListClusters": ListClusters,
    "ecs-clusters:RegisterTaskDefinition": RegisterTaskDefinition,
    "ecs-clusters:ListTaskDefinitions": ListTaskDefinitions,
    "ecs-clusters:DeregisterTaskDefinition": DeregisterTaskDefinition,
    "ecs-clusters:DeleteCluster": DeleteCluster,
    "ecs-tasks:RunTask": lambda ctx: RunTask(ctx),
    "ecs-tasks:DescribeTasks": lambda ctx: DescribeTasks(ctx),
    "ecs-tasks:ListTasks": lambda ctx: ListTasks(ctx),
    "ecs-tasks:StopTask": lambda ctx: StopTask(ctx),
    "ecs-services:CreateService": lambda ctx: CreateServiceFn(ctx),
    "ecs-services:DescribeServices": lambda ctx: DescribeServicesFn(ctx),
    "ecs-services:ListServices": lambda ctx: ListServicesFn(ctx),
    "ecs-services:UpdateService": lambda ctx: UpdateServiceFn(ctx),
    "ecs-services:DeleteService": lambda ctx: DeleteServiceFn(ctx),
}
