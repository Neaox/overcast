...
IMPLS = {
    # appsync-apis
    "appsync-apis:CreateGraphqlApi": CreateGraphqlApi,
    "appsync-apis:GetGraphqlApi": GetGraphqlApi,
    "appsync-apis:UpdateGraphqlApi": UpdateGraphqlApi,
    "appsync-apis:ListGraphqlApis": ListGraphqlApis,
    "appsync-apis:DeleteGraphqlApi": DeleteGraphqlApi,
    # appsync-schemas
    "appsync-schemas:StartSchemaCreation": StartSchemaCreation,
    "appsync-schemas:GetSchemaCreationStatus": GetSchemaCreationStatus,
    # appsync-api-keys
    "appsync-api-keys:CreateApiKey": CreateApiKey,
    "appsync-api-keys:ListApiKeys": ListApiKeys,
    "appsync-api-keys:UpdateApiKey": UpdateApiKey,
    "appsync-api-keys:DeleteApiKey": DeleteApiKey,
    # appsync-datasources
    "appsync-datasources:CreateDataSource": CreateDataSource,
    "appsync-datasources:GetDataSource": GetDataSource,
    "appsync-datasources:UpdateDataSource": UpdateDataSource,
    "appsync-datasources:ListDataSources": ListDataSources,
    "appsync-datasources:DeleteDataSource": DeleteDataSource,
    ...
    # appsync-resolvers
    "appsync-resolvers:CreateResolver": CreateResolver,
    "appsync-resolvers:GetResolver": GetResolver,
    "appsync-resolvers:UpdateResolver": UpdateResolver,
    "appsync-resolvers:ListResolvers": ListResolvers,
    "appsync-resolvers:ListResolversByFunction": ListResolversByFunction,
    "appsync-resolvers:DeleteResolver": DeleteResolver,
    # appsync-types
    "appsync-types:CreateType": CreateType,
    "appsync-types:GetType": GetType,
    "appsync-types:UpdateType": UpdateType,
    "appsync-types:ListTypes": ListTypes,
    "appsync-types:DeleteType": DeleteType,
    ...
    # appsync-env-vars
    "appsync-env-vars:PutGraphqlApiEnvironmentVariables": PutGraphqlApiEnvironmentVariables,
    "appsync-env-vars:GetGraphqlApiEnvironmentVariables": GetGraphqlApiEnvironmentVariables,
    # appsync-domains
    "appsync-domains:CreateDomainName": CreateDomainName,
    "appsync-domains:GetDomainName": GetDomainName,
    "appsync-domains:UpdateDomainName": UpdateDomainName,
    ...
    "appsync-domains:AssociateApi": AssociateApi,
    "appsync-domains:GetApiAssociation": GetApiAssociation,
    "appsync-domains:DisassociateApi": DisassociateApi,
    "appsync-domains:DeleteDomainName": DeleteDomainName,
    # appsync-cache
    "appsync-cache:CreateApiCache": CreateApiCache,
    "appsync-cache:GetApiCache": GetApiCache,
    "appsync-cache:UpdateApiCache": UpdateApiCache,
    "appsync-cache:FlushApiCache": FlushApiCache,
    "appsync-cache:DeleteApiCache": DeleteApiCache,
}
