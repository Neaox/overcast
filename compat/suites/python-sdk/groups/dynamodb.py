...
IMPLS = {
    "dynamodb-tables:CreateTable": CreateTable,
    "dynamodb-tables:DescribeTable": DescribeTable,
    "dynamodb-tables:ListTables": ListTables,
    "dynamodb-tables:UpdateTable": UpdateTable,
    "dynamodb-tables:DeleteTable": DeleteTable,
    "dynamodb-items:PutItem": PutItem,
    "dynamodb-items:GetItem": GetItem,
    "dynamodb-items:UpdateItem": UpdateItem,
    "dynamodb-items:PutItemConditionFail": PutItemConditionFail,
    "dynamodb-items:DeleteItem": DeleteItem,
    "dynamodb-query:Query": Query,
    "dynamodb-query:QueryWithFilterExpression": QueryWithFilterExpression,
    "dynamodb-query:QueryWithLimit": QueryWithLimit,
    "dynamodb-query:QueryPagination": QueryPagination,
    "dynamodb-query:Scan": Scan,
    "dynamodb-query:ScanWithFilter": ScanWithFilter,
    "dynamodb-batch:BatchWriteItem": BatchWriteItem,
    "dynamodb-batch:BatchGetItem": BatchGetItem,
    "dynamodb-txn:TransactWriteItems": TransactWriteItems,
    "dynamodb-txn:TransactGetItems": TransactGetItems,
    "dynamodb-txn:TransactWriteConditionFail": TransactWriteConditionFail,
    "dynamodb-ttl:UpdateTimeToLive": UpdateTimeToLive,
    "dynamodb-ttl:DescribeTimeToLive": DescribeTimeToLive,
}
