...
IMPLS = {
    "ses-send:SendEmail": SendEmail,
    "ses-send:SendRawEmail": SendRawEmail,
    "ses-send:SendEmailWithReplyTo": SendEmailWithReplyTo,
    "ses-identities:VerifyEmailIdentity": VerifyEmailIdentity,
    "ses-identities:ListIdentities": ListIdentities,
    "ses-identities:GetIdentityVerificationAttributes": GetIdentityVerificationAttributes,
    "ses-identities:VerifyEmailAddress": VerifyEmailAddress,
    "ses-identities:ListVerifiedEmailAddresses": ListVerifiedEmailAddresses,
    "ses-identities:DeleteIdentity": DeleteIdentity,
    "ses-send:GetSendQuota": GetSendQuota,
    "ses-identities:SetIdentityFeedbackForwardingEnabled": SetIdentityFeedbackForwardingEnabled,
    "ses-templates:CreateTemplate": CreateTemplate,
    "ses-templates:GetTemplate": GetTemplate,
    "ses-templates:UpdateTemplate": UpdateTemplate,
    "ses-templates:ListTemplates": ListTemplates,
    "ses-templates:SendTemplatedEmail": SendTemplatedEmail,
    "ses-templates:DeleteTemplate": DeleteTemplate,
}
