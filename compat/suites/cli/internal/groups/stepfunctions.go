...
func StepFunctions() ServiceGroup {
	...
	return ServiceGroup{
		Impls: map[string]harness.TestFn{
			"sfn-statemachines:CreateStateMachine":   g.CreateStateMachine,
			"sfn-statemachines:DescribeStateMachine": g.DescribeStateMachine,
			"sfn-statemachines:ListStateMachines":    g.ListStateMachines,
			"sfn-statemachines:StartExecution":       g.StartExecution,
			"sfn-statemachines:DeleteStateMachine":   g.DeleteStateMachine,
