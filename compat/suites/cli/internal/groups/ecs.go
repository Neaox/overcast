...
func ECS() ServiceGroup {
	...
	return ServiceGroup{
		Impls: map[string]harness.TestFn{
			...
			"ecs-clusters:DescribeClusters":         g.DescribeClusters,
			"ecs-clusters:ListClusters":             g.ListClusters,
			"ecs-clusters:RegisterTaskDefinition":   g.RegisterTaskDefinition,
			"ecs-clusters:ListTaskDefinitions":      g.ListTaskDefinitions,
			"ecs-clusters:DeregisterTaskDefinition": g.DeregisterTaskDefinition,
			"ecs-clusters:DeleteCluster":            g.DeleteCluster,
			"ecs-tasks:RunTask":                     g.RunTask,
			"ecs-tasks:DescribeTasks":               g.DescribeTasks,
			"ecs-tasks:ListTasks":                   g.ListTasks,
			"ecs-tasks:StopTask":                    g.StopTask,
			"ecs-services:CreateService":            g.CreateService,
			"ecs-services:DescribeServices":         g.DescribeServices,
			"ecs-services:ListServices":             g.ListServices,
			"ecs-services:UpdateService":            g.UpdateService,
			"ecs-services:DeleteService":            g.DeleteService,
		},
