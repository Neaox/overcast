...
public final class DynamoDbGroup implements ServiceGroup {
    ...
    public Map<String, TestFn> impls() {
        return Map.ofEntries(
                Map.entry("dynamodb-tables:CreateTable",              this::createTable),
                Map.entry("dynamodb-tables:DescribeTable",            this::describeTable),
                Map.entry("dynamodb-tables:ListTables",               this::listTables),
                Map.entry("dynamodb-tables:UpdateTable",              this::updateTable),
                Map.entry("dynamodb-tables:DeleteTable",              this::deleteTable),
                Map.entry("dynamodb-items:PutItem",                   this::putItem),
                Map.entry("dynamodb-items:GetItem",                   this::getItem),
                Map.entry("dynamodb-items:UpdateItem",                this::updateItem),
                Map.entry("dynamodb-items:PutItemConditionFail",      this::putItemConditionFail),
                Map.entry("dynamodb-items:DeleteItem",                this::deleteItem),
                Map.entry("dynamodb-query:Query",                     this::query),
                Map.entry("dynamodb-query:QueryWithFilterExpression", this::queryWithFilterExpression),
                Map.entry("dynamodb-query:QueryWithLimit",            this::queryWithLimit),
                Map.entry("dynamodb-query:QueryPagination",           this::queryPagination),
                Map.entry("dynamodb-query:Scan",                      this::scan),
                Map.entry("dynamodb-query:ScanWithFilter",            this::scanWithFilter),
                Map.entry("dynamodb-batch:BatchWriteItem",            this::batchWriteItem),
                Map.entry("dynamodb-batch:BatchGetItem",              this::batchGetItem),
                Map.entry("dynamodb-txn:TransactWriteItems",          this::transactWriteItems),
                Map.entry("dynamodb-txn:TransactGetItems",            this::transactGetItems),
                Map.entry("dynamodb-txn:TransactWriteConditionFail",  this::transactWriteConditionFail),
                Map.entry("dynamodb-ttl:UpdateTimeToLive",            this::updateTimeToLive),
                Map.entry("dynamodb-ttl:DescribeTimeToLive",          this::describeTimeToLive)
        );
    }
