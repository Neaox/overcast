...
public final class LambdaGroup implements ServiceGroup {
    ...
    public Map<String, TestFn> impls() {
        return Map.ofEntries(
                ...
                Map.entry("lambda-crud:UpdateFunctionCode",                this::updateFunctionCode),
                Map.entry("lambda-crud:UpdateFunctionConfiguration",       this::updateFunctionConfiguration),
                ...
                Map.entry("lambda-invoke:InvokeDryRun",                    this::invokeDryRun),
                Map.entry("lambda-invoke:InvokeSync",                      this::invokeSync),
                Map.entry("lambda-invoke:InvokeAsync",                     this::invokeAsync),
                Map.entry("lambda-invoke-stream:InvokeWithResponseStream", this::invokeWithResponseStream),
                Map.entry("lambda-invoke-error:InvokeWithError",           this::invokeWithError),
                Map.entry("lambda-aliases:PublishVersion",                 this::publishVersion),
                Map.entry("lambda-aliases:ListVersionsByFunction",         this::listVersionsByFunction),
                Map.entry("lambda-aliases:CreateAlias",                    this::createAlias),
                Map.entry("lambda-aliases:GetAlias",                       this::getAlias),
                Map.entry("lambda-aliases:ListAliases",                    this::listAliases),
                Map.entry("lambda-aliases:UpdateAlias",                    this::updateAlias),
                Map.entry("lambda-aliases:DeleteAlias",                    this::deleteAlias),
                Map.entry("lambda-layers:PublishLayerVersion",             this::publishLayerVersion),
                Map.entry("lambda-layers:ListLayers",                      this::listLayers),
                Map.entry("lambda-layers:DeleteLayerVersion",              this::deleteLayerVersion)
        );
    }
