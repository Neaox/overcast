...
public final class RdsGroup implements ServiceGroup {
    ...
    public Map<String, TestFn> impls() {
        return Map.ofEntries(
                Map.entry("rds-instances:DescribeDBEngineVersions",              this::describeDbEngineVersions),
                Map.entry("rds-instances:CreateDBInstance",                      this::createDbInstance),
                Map.entry("rds-instances:DescribeDBInstances",                   this::describeDbInstances),
                Map.entry("rds-instances:StopDBInstance",                        this::stopDbInstance),
                Map.entry("rds-instances:StartDBInstance",                       this::startDbInstance),
                Map.entry("rds-instances:ModifyDBInstance",                      this::modifyDbInstance),
                Map.entry("rds-instances:DeleteDBInstance",                      this::deleteDbInstance),
                Map.entry("rds-subnet-groups:CreateDBSubnetGroup",               this::createDbSubnetGroup),
                Map.entry("rds-subnet-groups:DescribeDBSubnetGroups",            this::describeDbSubnetGroups),
                Map.entry("rds-subnet-groups:DeleteDBSubnetGroup",               this::deleteDbSubnetGroup),
                Map.entry("rds-parameter-groups:CreateDBParameterGroup",         this::createDbParameterGroup),
                Map.entry("rds-parameter-groups:DescribeDBParameterGroups",      this::describeDbParameterGroups),
                Map.entry("rds-parameter-groups:DeleteDBParameterGroup",         this::deleteDbParameterGroup),
                Map.entry("rds-clusters:CreateDBCluster",                        this::createDbCluster),
                Map.entry("rds-clusters:DescribeDBClusters",                     this::describeDbClusters),
                Map.entry("rds-clusters:ModifyDBCluster",                        this::modifyDbCluster),
                Map.entry("rds-clusters:StopDBCluster",                          this::stopDbCluster),
                Map.entry("rds-clusters:StartDBCluster",                         this::startDbCluster),
                Map.entry("rds-clusters:DeleteDBCluster",                        this::deleteDbCluster),
                Map.entry("rds-cluster-members:CreateClusterForMembers",         this::createClusterForMembers),
                Map.entry("rds-cluster-members:AddClusterMember",                this::addClusterMember),
                Map.entry("rds-cluster-members:DescribeClusterMembers",          this::describeClusterMembers),
                Map.entry("rds-cluster-members:DescribeMemberInheritedSettings", this::describeMemberInheritedSettings),
                Map.entry("rds-cluster-members:RemoveClusterMember",             this::removeClusterMember),
                Map.entry("rds-cluster-members:DeleteClusterAfterMembers",       this::deleteClusterAfterMembers)
        );
    }
