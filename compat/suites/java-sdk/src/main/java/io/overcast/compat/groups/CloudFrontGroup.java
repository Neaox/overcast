...
public final class CloudFrontGroup implements ServiceGroup {
    ...
    public Map<String, TestFn> impls() {
        return Map.ofEntries(
                // distributions
                Map.entry("cloudfront-distributions:CreateDistribution", this::createDistribution),
                Map.entry("cloudfront-distributions:GetDistribution",    this::getDistribution),
                Map.entry("cloudfront-distributions:ListDistributions",  this::listDistributions),
                Map.entry("cloudfront-distributions:DeleteDistribution", this::deleteDistribution),
                // oac
                Map.entry("cloudfront-oac:CreateOriginAccessControl", this::createOriginAccessControl),
                Map.entry("cloudfront-oac:GetOriginAccessControl",    this::getOriginAccessControl),
                Map.entry("cloudfront-oac:UpdateOriginAccessControl", this::updateOriginAccessControl),
                Map.entry("cloudfront-oac:ListOriginAccessControls",  this::listOriginAccessControls),
                Map.entry("cloudfront-oac:DeleteOriginAccessControl", this::deleteOriginAccessControl),
                // cache policy
                Map.entry("cloudfront-cache-policy:CreateCachePolicy",    this::createCachePolicy),
                Map.entry("cloudfront-cache-policy:GetCachePolicy",       this::getCachePolicy),
                Map.entry("cloudfront-cache-policy:GetCachePolicyConfig", this::getCachePolicyConfig),
                Map.entry("cloudfront-cache-policy:UpdateCachePolicy",    this::updateCachePolicy),
                Map.entry("cloudfront-cache-policy:ListCachePolicies",    this::listCachePolicies),
                Map.entry("cloudfront-cache-policy:DeleteCachePolicy",    this::deleteCachePolicy),
                // key group
                Map.entry("cloudfront-key-group:CreateKeyGroup",    this::createKeyGroup),
                Map.entry("cloudfront-key-group:GetKeyGroup",       this::getKeyGroup),
                Map.entry("cloudfront-key-group:GetKeyGroupConfig", this::getKeyGroupConfig),
                Map.entry("cloudfront-key-group:UpdateKeyGroup",    this::updateKeyGroup),
                Map.entry("cloudfront-key-group:ListKeyGroups",     this::listKeyGroups),
                Map.entry("cloudfront-key-group:DeleteKeyGroup",    this::deleteKeyGroup),
                // realtime log
                Map.entry("cloudfront-realtime-log:CreateRealtimeLogConfig", this::createRealtimeLogConfig),
                Map.entry("cloudfront-realtime-log:GetRealtimeLogConfig",    this::getRealtimeLogConfig),
                Map.entry("cloudfront-realtime-log:UpdateRealtimeLogConfig", this::updateRealtimeLogConfig),
                Map.entry("cloudfront-realtime-log:ListRealtimeLogConfigs",  this::listRealtimeLogConfigs),
                Map.entry("cloudfront-realtime-log:DeleteRealtimeLogConfig", this::deleteRealtimeLogConfig),
                // monitoring
                Map.entry("cloudfront-monitoring:CreateMonitoringSubscription", this::createMonitoringSubscription),
                Map.entry("cloudfront-monitoring:GetMonitoringSubscription",    this::getMonitoringSubscription),
                Map.entry("cloudfront-monitoring:DeleteMonitoringSubscription", this::deleteMonitoringSubscription),
                // fle config
                Map.entry("cloudfront-fle-config:CreateFieldLevelEncryptionConfig", this::createFieldLevelEncryptionConfig),
                Map.entry("cloudfront-fle-config:GetFieldLevelEncryption",          this::getFieldLevelEncryption),
                Map.entry("cloudfront-fle-config:GetFieldLevelEncryptionConfig",    this::getFieldLevelEncryptionConfig),
                Map.entry("cloudfront-fle-config:UpdateFieldLevelEncryptionConfig", this::updateFieldLevelEncryptionConfig),
                Map.entry("cloudfront-fle-config:ListFieldLevelEncryptionConfigs",  this::listFieldLevelEncryptionConfigs),
                Map.entry("cloudfront-fle-config:DeleteFieldLevelEncryption",       this::deleteFieldLevelEncryption),
                // fle profile
                Map.entry("cloudfront-fle-profile:CreateFieldLevelEncryptionProfile",    this::createFieldLevelEncryptionProfile),
                Map.entry("cloudfront-fle-profile:GetFieldLevelEncryptionProfile",       this::getFieldLevelEncryptionProfile),
                Map.entry("cloudfront-fle-profile:GetFieldLevelEncryptionProfileConfig", this::getFieldLevelEncryptionProfileConfig),
                Map.entry("cloudfront-fle-profile:UpdateFieldLevelEncryptionProfile",    this::updateFieldLevelEncryptionProfile),
                Map.entry("cloudfront-fle-profile:ListFieldLevelEncryptionProfiles",     this::listFieldLevelEncryptionProfiles),
                Map.entry("cloudfront-fle-profile:DeleteFieldLevelEncryptionProfile",    this::deleteFieldLevelEncryptionProfile),
                // continuous deployment
                Map.entry("cloudfront-continuous-deployment:CreateContinuousDeploymentPolicy",    this::createContinuousDeploymentPolicy),
                Map.entry("cloudfront-continuous-deployment:GetContinuousDeploymentPolicy",       this::getContinuousDeploymentPolicy),
                Map.entry("cloudfront-continuous-deployment:GetContinuousDeploymentPolicyConfig", this::getContinuousDeploymentPolicyConfig),
                Map.entry("cloudfront-continuous-deployment:UpdateContinuousDeploymentPolicy",    this::updateContinuousDeploymentPolicy),
                Map.entry("cloudfront-continuous-deployment:ListContinuousDeploymentPolicies",    this::listContinuousDeploymentPolicies),
                Map.entry("cloudfront-continuous-deployment:DeleteContinuousDeploymentPolicy",    this::deleteContinuousDeploymentPolicy)
        );
    }
