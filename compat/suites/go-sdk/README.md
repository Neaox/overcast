# compat/suites/go — Go (AWS SDK Go v2)
...
- All services already tested by `node-js-sdk`, cross-validated with the Go SDK
- Go-specific patterns (context propagation, iterator API, etc.)
