...
func DynamoDB(c *clients.Clients) ServiceGroup {
	...
	return ServiceGroup{
		Impls: map[string]harness.TestFn{
			"dynamodb-tables:CreateTable":              g.CreateTable,
			"dynamodb-tables:DescribeTable":            g.DescribeTable,
			"dynamodb-tables:ListTables":               g.ListTables,
			"dynamodb-tables:UpdateTable":              g.UpdateTable,
			"dynamodb-tables:DeleteTable":              g.DeleteTable,
			"dynamodb-items:PutItem":                   g.PutItem,
			"dynamodb-items:PutItemConditionFail":      g.PutItemConditionFail,
			"dynamodb-items:GetItem":                   g.GetItem,
			"dynamodb-items:UpdateItem":                g.UpdateItem,
			"dynamodb-items:DeleteItem":                g.DeleteItem,
			"dynamodb-query:Scan":                      g.Scan,
			"dynamodb-query:Query":                     g.Query,
			"dynamodb-query:QueryWithFilterExpression": g.QueryWithFilterExpression,
			"dynamodb-query:QueryWithLimit":            g.QueryWithLimit,
			"dynamodb-query:QueryPagination":           g.QueryPagination,
			"dynamodb-query:ScanWithFilter":            g.ScanWithFilter,
			"dynamodb-batch:BatchWriteItem":            g.BatchWriteItem,
			"dynamodb-batch:BatchGetItem":              g.BatchGetItem,
			"dynamodb-txn:TransactWriteItems":          g.TransactWriteItems,
			"dynamodb-txn:TransactGetItems":            g.TransactGetItems,
			"dynamodb-txn:TransactWriteConditionFail":  g.TransactWriteConditionFail,
			"dynamodb-ttl:UpdateTimeToLive":            g.UpdateTimeToLive,
			"dynamodb-ttl:DescribeTimeToLive":          g.DescribeTimeToLive,
		},
